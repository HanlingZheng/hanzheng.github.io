...
myImage.addEventListener("click",() => {
	...
	if (mySrc === "/First-Website/Image/logo.jpg") {
	myImage.setAttribute("src", "/First-Website/Image/basketball.jpeg");
	}
	else {
	myImage.setAttribute("src","/First-Website/Image/logo.jpg");
	}
});
